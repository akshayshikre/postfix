# docker-postfix
[![Docker Stars](https://img.shields.io/docker/stars/akshayshikre/postfix.svg?style=flat-square)](https://hub.docker.com/r/akshayshikre/postfix/)
[![Docker Pulls](https://img.shields.io/docker/pulls/akshayshikre/postfix.svg?style=flat-square)](https://hub.docker.com/r/akshayshikre/postfix/)
...
Or you can use the provided [docker-compose](https://github.com/akshayshikre/docker-postfix/blob/master/docker-compose.dev.yml) files:

    sudo docker-compose -f docker-compose.yml -f docker-compose.dev.yml build

For more information on using multiple compose files [see here](https://docs.docker.com/compose/production/). You can also find a prebuilt docker image from [Docker Hub](https://registry.hub.docker.com/u/akshayshikre/postfix/), which can be pulled with this command:

    sudo docker pull akshayshikre/postfix:latest
...
Or if you can start the service using the provided [docker-compose](https://github.com/akshayshikre/docker-postfix/blob/master/docker-compose.yml) file for production use:
